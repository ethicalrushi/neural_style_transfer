...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 12 17:31:09 2019
...
OUTPUT_DIR = 'out_ad/'
# Style image to use.
STYLE_IMAGE = 'artbilli.jpg'
# Content image to use.
CONTENT_IMAGE = 'abilli.jpg'
...
#sty_img =scipy.misc.imread(STYLE_IMAGE, mode='RGB')
#con_img = scipy.misc.imread(CONTENT_IMAGE, mode='RGB')

#con_img.resize((750,346,3))
#save_image('abilli.jpg',con_img)
...
for it in range(ITERATIONS):
    ...
    if it%10 == 0:
        ...
        filename = 'out_ad/%d.png' % (it)
        save_image(filename, mixed_image)


save_image('out_ad/art.jpg', mixed_image)
